...
# def rm(flags=[], params=[], redirects=None):
#   files = glob.glob("*.txt")
#   #cwd = os.getcwd()
#   #os.chdir(path)
...
#   print(os.path.isfile(params[0]))

#   # recursively delete a folder with files inside of it
#   if flags:
#     if flags[0] == '-r':
#       shutil.rmtree(params[0])
#       print(f"{params[0]} was deleted")
